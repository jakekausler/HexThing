...
public class HexMesh : MonoBehaviour
{
	...
	void TriangulateCornerTerracesCliff (Vector3 begin, HexCell beginCell, Vector3 left, HexCell leftCell, Vector3 right, HexCell rightCell) {
		...
		TriangulateBoundaryCorner(begin, beginCell, left, leftCell, boundary, boundaryColor);

		if (leftCell.GetEdgeType(rightCell) == HexEdgeType.Slope) {
			TriangulateBoundaryCorner(left, leftCell, right, rightCell, boundary, boundaryColor);
		} else {
	...
	void TriangulateCornerCliffTerraces (Vector3 begin, HexCell beginCell, Vector3 left, HexCell leftCell, Vector3 right, HexCell rightCell) {
		...
		TriangulateBoundaryCorner(right, rightCell, begin, beginCell, boundary, boundaryColor);
	...
	void TriangulateBoundaryCorner (Vector3 begin, HexCell beginCell, Vector3 left, HexCell leftCell, Vector3 boundary, Color boundaryColor) {
